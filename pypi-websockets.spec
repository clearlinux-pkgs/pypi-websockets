...
Source0  : https://files.pythonhosted.org/packages/21/e6/26d09fab466b7ca9c7737474c52be4f76a40301b08362eb2dbc19dcc16c1/websockets-15.0.1.tar.gz
Summary  : An implementation of the WebSocket Protocol (RFC 6455 & 7692)
Group    : Development/Tools
License  : BSD-3-Clause
Requires: pypi-websockets-bin = %{version}-%{release}
...
%package bin
Summary: bin components for the pypi-websockets package.
Group: Binaries
Requires: pypi-websockets-license = %{version}-%{release}

%description bin
bin components for the pypi-websockets package.
...
%prep
%setup -q -n websockets-15.0.1
cd %{_builddir}/websockets-15.0.1
pushd ..
cp -a websockets-15.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741218916
