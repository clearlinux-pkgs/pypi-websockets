...
%prep
%setup -q -n websockets-10.4
cd %{_builddir}/websockets-10.4
pushd ..
cp -a websockets-10.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666744081
...
cp %{_builddir}/websockets-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-websockets/b61db1cb007caaf9118a9bf274e9a07ed1875d2c || :
