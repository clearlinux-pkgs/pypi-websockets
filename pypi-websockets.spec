...
Source0  : https://files.pythonhosted.org/packages/2e/7a/8bc4d15af7ff30f7ba34f9a172063bfcee9f5001d7cef04bee800a658f33/websockets-15.0.tar.gz
...
%prep
%setup -q -n websockets-15.0
cd %{_builddir}/websockets-15.0
pushd ..
cp -a websockets-15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739815517
